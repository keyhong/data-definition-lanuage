...
, mtr_no VARCHAR(20)
, admd_cd VARCHAR(10)
, cnt_x_crd DECIMAL(18, 10)
, cnt_y_crd DECIMAL(18, 10)
, min_x_crd DECIMAL(18, 10)
, min_y_crd DECIMAL(18, 10)
, max_x_crd DECIMAL(18, 10)
, max_y_crd DECIMAL(18, 10)
, cnt_la DECIMAL(12, 10)
, cnt_lo DECIMAL(13, 10)
, min_la DECIMAL(12, 10)
, min_lo DECIMAL(13, 10)
, max_la DECIMAL(12, 10)
, max_lo DECIMAL(13, 10)
, cctv_co SMALLINT
);
