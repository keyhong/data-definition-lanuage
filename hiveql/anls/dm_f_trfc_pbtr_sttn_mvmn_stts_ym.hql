--(T)대중교통스테이션별이동현황월별
CREATE EXTERNAL TABLE IF NOT EXISTS ANLS.DM_F_TRFC_PBTR_STTN_MVMN_STTS_YM (
  stdr_ym                      STRING               COMMENT   '기준년월@pk' 
...
COMMENT '대중교통스테이션별이동현황월별'
PARTITIONED BY (pt_stdr_ym STRING COMMENT '파티션기준년월')
ROW FORMAT DELIMITED FIELDS TERMINATED BY '\u0002'
STORED AS ORC
LOCATION  '/lake/mart/ANLS/DM_F_TRFC_PBTR_STTN_MVMN_STTS_YM'
